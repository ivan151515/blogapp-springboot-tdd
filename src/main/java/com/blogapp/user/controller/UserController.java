...
public class UserController {
    ...
    // @GetMapping("/users/{id}")
    // public ResponseEntity<UserRestModel> getUserProfileWithBlogs(@PathVariable
    // Long id) {

    // return new ResponseEntity<UserRestModel>(new
    // UserRestModel(userService.getUserWithProfileAndBlogs(id)),
    // HttpStatus.OK);
    // }
}
